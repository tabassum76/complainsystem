...
<?php include "C:/wamp64/www/CMS/admin/includes/navi.php";?>
    ...
    if(isset($_GET['source'])){
       $source=$_GET['source'];
        ...
        switch($source){
            case 'add_user':
            include "C:/wamp64/www/CMS/admin/includes/add_user.php";
                break;
            case 'edit_user':
            include "C:/wamp64/www/CMS/admin/includes/edit_user.php";
            ...
            case 30:
                ...
                break;
            default:
                include "C:/wamp64/www/CMS/admin/includes/view_all_users.php";
                break;
